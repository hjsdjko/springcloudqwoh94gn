...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#edeff1"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="目的地" prop="mudedi">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="路线名称" prop="luxianmingcheng">
            <el-input v-model="ruleForm.luxianmingcheng" 
                placeholder="路线名称" clearable :disabled=" false  ||ro.luxianmingcheng"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="发票" v-if="type!='cross' || (type=='cross' && !ro.fapiao)" prop="fapiao">
            <file-upload
            tip="点击上传发票"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' class="upload" v-else label="发票" prop="fapiao">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="司机账号" prop="sijizhanghao">
            <el-input v-model="ruleForm.sijizhanghao" 
                placeholder="司机账号" clearable :disabled=" false  ||ro.sijizhanghao"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="司机姓名" prop="sijixingming">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="行程信息" prop="xingchengxinxi">
            <editor 
...
<script>
  export default {
      ...
      init(type) {
        ...
        this.$http.get(this.userTableName + '/session', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            ...
            if((json.sijizhanghao!=''&&json.sijizhanghao) || json.sijizhanghao==0){
                this.ruleForm.sijizhanghao = json.sijizhanghao            }
            if((json.sijixingming!=''&&json.sijixingming) || json.sijixingming==0){
    ...
    // 多级联动参数
      // 多级联动参数
      info() {
        this.$http.get(`xingchengxinxi/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
			...
			this.$refs["ruleForm"].validate(valid => {
				if(valid) {
					...
					if(crossrefid && crossuserid) {
						...
						this.$http.get('xingchengxinxi/list', {
							params: params
						}).then(res => {
							if(res.data.data.total>=crossoptnum) {
								...
								this.$http.post(`xingchengxinxi/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
									if (res.data.code == 0) {
										this.$message({
											message: '操作成功',
											type: 'success',
