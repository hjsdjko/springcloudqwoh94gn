...
public class XingchengxinxiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public XingchengxinxiEntity() {
		
	}
	
	public XingchengxinxiEntity(T t) {
		try {
	 ...
	 * 设置：行程信息
	 */
	public void setXingchengxinxi(String xingchengxinxi) {
		this.xingchengxinxi = xingchengxinxi;
	}
	/**
	 * 获取：行程信息
	 */
	public String getXingchengxinxi() {
		return xingchengxinxi;
	}
	/**
	 * 设置：司机账号
	 */
